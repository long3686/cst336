...
if (isset($_GET['addPokemonForm'])){
    ...
    echo "<script>
    alert('Pokemon has been added successfully!')
    </script>";
...
<body>
  <div>
        ...
        <h2>Enter the data of the Pokemon you want to add to the Pokedex</h2>
        <form>
            Pokemon Name: <input type="text" name="pokemonName" required /> <br>
            Pokemon Type 1: <select name="type1">
                ...
                <input type="submit" name="addPokemonForm" value="Add Pokemon!"/>
        </form>
